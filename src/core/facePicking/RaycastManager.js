...
export class RaycastManager {
   ...
   */
  screenToNDC(clientX, clientY, rect) {
   ...
   */
  intersectFaces(mousePosition, meshes, options = {}) {
    // 输入验证
   ...
   */
  intersectFacesWithDepthSorting(mousePosition, meshes) {
