...
type StateManagerChangeHandler = ((type: string, payload: any) => void) | null
...
export class StateManager {
  _viewer: any
  _store: any
  _onChange: StateManagerChangeHandler
  _state: StateManagerState
  _textCounter: number
  _syncing: boolean
  ...
  async _syncToViewer() {
    ...
    const viewerTextIds = new Set<string>(viewerTexts.map((t: any) => String(t.id)))
