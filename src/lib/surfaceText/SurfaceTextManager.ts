...
export class SurfaceTextManager {
  ...
  inputOverlay: TextInputOverlay
  transformControls: TextTransformControls
  ...
  _engravingDirtyMeshes: Set<string>
  isEditing: boolean
  isDragging: boolean
  meshTextMap: Map<string, Set<string>>

  eventListeners: Map<string, Function[]>
  _boundOnClick: (event: MouseEvent) => void
   ...
   */
  async setViewMode (mode, options: Record<string, any> = {}) {
